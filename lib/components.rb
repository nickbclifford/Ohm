...
class Ohm
  ...
  COMPONENTS = {
    ...
    'h' => ->(a){arr_else_chars(a).first},
    'i' => ->(a){arr_else_chars(a).last},
    ...
    "\u2561" => ->(a){a = arr_else_chars(a); [a.first, a.last]},
    "\u2562" => ->{},
    "\u2556" => ->{},
    "\u2555" => ->{},
    ...
    "\u253C" => ->{input_access(0)},
    "\u255E" => ->(a){arr_else_chars_inner_join(a) {|a| a.group_by {|x| x}.values}},
    ...
    "\u03C6" => ->(a){a = a.to_i; a.prime_division.map {|x| 1 - (1.0 / x[0])}.reduce(a, :*).to_i},
